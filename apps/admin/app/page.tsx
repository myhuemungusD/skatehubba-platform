    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <p className="text-gray-400">
          Product and listing management tools coming soon...
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <p className="text-gray-400">
          Detailed analytics charts and graphs coming soon...
        </p>
      </div>
    </div>
  );
...
function StatCard({
  ...
  return (
    <div
      className={`bg-gray-800 rounded-lg p-6 ${urgent ? "border-2 border-red-500" : ""}`}
    >
      ...
      <div className="flex items-end justify-between">
        ...
        {change && (
          <span
            className={`text-sm ${urgent ? "text-red-400" : "text-green-400"}`}
          >
            {change}
          </span>
        )}
...
function ActivityItem({
  ...
  return (
    <div
      className={`flex items-start gap-4 pb-4 border-b border-gray-700 last:border-0 last:pb-0 ${urgent ? "text-red-400" : ""}`}
    >
