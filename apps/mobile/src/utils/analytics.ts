...
import { getWebInstrumentations, initializeWebInstrumentation } from '@honeycombio/opentelemetry-web';

// Configuration for Honeycomb
const HONEYCOMB_API_KEY = process.env.EXPO_PUBLIC_HONEYCOMB_API_KEY || 'mock-key';
...
export const initAnalytics = () => {
  if (__DEV__) {
    console.log('[Analytics] Dev mode: Skipping full OTel init to save resources');
    return;
  }
