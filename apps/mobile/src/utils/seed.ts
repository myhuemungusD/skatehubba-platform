...
const SEED_SPOTS: SkateSpot[] = [
  {
    ...
    description:
      "The legendary 20 stair. Huge rails, massive impact. Enter through the side gate.",
  ...
  },
  {
    ...
    description:
      "Iconic beachfront concrete. Snake runs, bowls, and a street plaza. Crowded on weekends.",
  ...
  },
  {
    ...
    name: "Burnside DIY",
    description:
      "The godfather of DIY parks. Fast, tight transitions under the bridge. Respect the locals.",
  ...
  },
  {
    ...
    name: "MACBA",
    description:
      "The ledge capital of the world. Smooth ground, long ledges, and good vibes.",
...
const SEED_USER: UserProfile = {
  ...
  stance: "Goofy",
  avatarUrl:
    "https://api.dicebear.com/9.x/avataaars/png?seed=skater123&backgroundColor=b6e3f4",
  level: 42,
  xp: 8450,
