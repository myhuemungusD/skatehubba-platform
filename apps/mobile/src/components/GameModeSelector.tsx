    ...
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={[styles.optionText, selectedMode === 'SK8' && styles.textSelected]}>
            SK8
          </Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={[styles.optionText, selectedMode === 'SKATE' && styles.textSelected]}>
            SKATE
          </Text>
      ...
      <View style={styles.ruleContainer}>
        ...
        <Text style={styles.ruleText}>
          "Clip must clearly start with the skater positioning for the trick and end with a clean roll-away and full stop."
        </Text>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 14, fontWeight: '900', color: '#666', marginBottom: 10, letterSpacing: 1 },
  ...
  ruleContainer: { backgroundColor: '#fffbe6', padding: 12, borderRadius: 6, borderWidth: 1, borderColor: '#ffe58f' },
  ruleLabel: { fontSize: 12, fontWeight: 'bold', color: '#d48806', marginBottom: 4 },
  ruleText: { fontSize: 13, color: '#333', fontStyle: 'italic', lineHeight: 18 },
});
