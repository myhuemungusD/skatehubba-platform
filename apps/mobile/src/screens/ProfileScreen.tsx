...
export default function ProfileScreen() {
  ...
  const handleEnterChambers = async () => {
    ...
    if (!uid) {
      Alert.alert(
        "Sign In Required",
        "You must be signed in to access the Judge Chambers.",
      );
      return;
    }
  ...
  const coverImage =
    "https://images.unsplash.com/photo-1547447134-cd3f5c716030?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80";
        ...
        <View style={styles.tabRow}>
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "CLIPS" && styles.activeTabText,
              ]}
            >
              MY CLIPS
            </Text>
