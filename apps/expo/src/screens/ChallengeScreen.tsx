...
const activeChallenge: ChallengeData = {
  ...
  description:
    "Land a clean kickflip down a 3-stair set or higher. No toe drag allowed! Upload your best angle.",
  difficulty: "Medium",
  xpReward: 500,
  timeLeft: "14h 20m",
  participants: 124,
  bgImage:
    "https://images.unsplash.com/photo-1564982752979-3f7bc974d29a?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
};
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.heroContainer}>
        <Image
          source={{ uri: activeChallenge.bgImage }}
      ...
      >
        ...
        <View style={styles.section}>
          ...
          {["Must be outside", "No edit cuts", "Board must be visible"].map(
            (rule, index) => (
