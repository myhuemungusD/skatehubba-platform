  ...
  return (
    <BackgroundCarousel className="text-white">
      ...
      <section className="py-20 bg-black text-center border-t border-orange-500/10">
        <h2 className="text-3xl mb-6 text-orange-400">Join 1,000+ Skaters</h2>
      ...
      >
        <h2 className="text-4xl mb-6 text-orange-400">Get Early Access</h2>
      ...
      <section className="py-20 bg-black border-t border-orange-500/10 text-center">
        <DonorRecognition />
        <h3 className="text-2xl text-orange-400 mb-4">Follow the Movement</h3>
      ...
      <footer className="py-8 text-center text-gray-400 bg-black border-t border-orange-400/10">
        <small>
          &copy; 2025{" "}
          <span className="text-orange-400 font-semibold">SkateHubba</span> —
          Own Your Tricks.
        </small>
      </footer>
    </BackgroundCarousel>
