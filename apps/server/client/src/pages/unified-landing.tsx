    ...
    <Background className="text-white min-h-screen">
      ...
      <Section className="pt-12 pb-12">
        <div className="text-center" style={springAnimation.style}>
          ...
          <div
            className="flex flex-wrap justify-center items-center gap-6 md:gap-8 mb-10 text-sm text-gray-400 px-4"
          ...
          <div className="text-center mb-12">
            <Link to="/auth">
              <button className="auth-button" data-testid="button-auth-primary">
            ...
            {[
              {
                ...
                desc: "Challenge skaters worldwide",
              },
              {
                icon: MapPin,
                title: "Spot Check-ins",
                desc: "Discover and share locations",
              },
              {
                icon: Trophy,
                title: "Trick Collectibles",
                desc: "Mint your best moments",
              },
            ].map((feature, index) => (
              <div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  <strong className="text-white">Remote S.K.A.T.E.:</strong>{" "}
                  Video challenges with 24-hour timers and trick validation
                </p>
                <p>
                  <strong className="text-white">Live Sessions:</strong> Stream
                  and spectate with the community
                </p>
                <p>
                  <strong className="text-white">Trenches Feed:</strong> Share
                  clips and get feedback
                </p>
                <p>
                  <strong className="text-white">Digital Closet:</strong>{" "}
                  Customize avatars and flex gear
                </p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  ...
                  Your tricks are minted as unique collectibles
                </p>
                <p>
                  <strong className="text-white">Trade & Collect:</strong>{" "}
                  Exchange rare gear and earn exclusive drops
                </p>
                <p>
                  <strong className="text-white">Pro Collaborations:</strong>{" "}
                  Unlock secret challenges from your favorite pros
                </p>
                <p>
                  <strong className="text-white">Moment Ownership:</strong> From
                  first-try rails to MBD at your local spot
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="py-8 px-6 border-t border-white/20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-400">
            The ultimate skateboarding social platform
          </p>
        </div>
      </footer>
