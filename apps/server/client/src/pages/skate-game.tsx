...
export default function SkateGamePage() {
  ...
  const submitTrickMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await apiRequest("POST", `/api/games/${gameId}/trick`, {
        userId: user?.uid,
        trick,
      });
      return response.json();
      ...
      <div className="min-h-screen bg-[#181818]">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-300">
            Please log in to play S.K.A.T.E. games.
          </p>
        </div>
      </div>
    );
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-300">
                Challenge skaters worldwide to a game of S.K.A.T.E.
              </p>
            </div>
            <Button
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  <p className="text-gray-400">
                    No active games. Create or join a game to start playing!
                  </p>
                </div>
              ) : (
